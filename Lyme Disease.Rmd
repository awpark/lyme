...
```{r}
ggplot(ld.pres.total,aes(x=log10(prcp),y=log10(cases)))+geom_point(data=subset(ld.pres.total,year==2000,stat=identity))

ggplot(ld.pres.total,aes(x=log10(prcp),y=log10(cases)))+geom_point(data=subset(ld.pres.total,year==2008,stat=identity))

ggplot(ld.pres.total,aes(x=log10(prcp),y=log10(cases)))+geom_point(data=subset(ld.pres.total,year==2009,stat=identity))+geom_smooth()
#Deer
...
ggplot(ld.pop.edit,aes(x=log10(pop),y=cases))+geom_point(data=subset(ld.pop.edit,year==2005,stat=identity))+geom_smooth()

ggplot(ld.pop.edit,aes(x=log10(pop),y=log10(cases)))+geom_point(data=subset(ld.pop.edit,year==2009,stat=identity))+geom_smooth()

ggplot(ld.pop.edit,aes(x=log10(pop),y=log10(cases)))+geom_point(data=subset(ld.pop.edit,year==2008,stat=identity))+geom_smooth()

#Temperature

ggplot(ld.pres.total,aes(x=log10(avtemp),y=log10(cases)))+geom_point(data=subset(ld.pres.total,year==2009,stat=identity))+geom_smooth()

ggplot(ld.pres.total,aes(x=log10(avtemp),y=log10(cases)))+geom_point(data=subset(ld.pres.total,year==2008,stat=identity))+geom_smooth()

ggplot(ld.pres.total,aes(x=log10(avtemp),y=log10(cases)))+geom_point(data=subset(ld.pres.total,year==2005,stat=identity))+geom_smooth()

ggplot(ld.pres.total,aes(x=log10(avtemp),y=log10(cases)))+geom_point(data=subset(ld.pres.total,year==2006,stat=identity))+geom_smooth()
